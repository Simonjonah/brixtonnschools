          ...
          <div class="invoice p-3 mb-3">
            ...
            <div class="row invoice-info">
              <div class="col-sm-4 invoice-col">
                <img style="width: 300px; height: 100px;" src="{{ asset('assets/dist/img/AdminLTELogo.jpg') }}" alt=""> 

                <address>
                  <strong>BRIXTONN SCHOOLS</strong><br>
                  @if ($prints_queries->centername = 'Uyo')
                  Unit 13 F-Line Ewet Housing Estate, Uyo <br>
