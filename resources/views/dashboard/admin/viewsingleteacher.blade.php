        ...
        <div class="row">
            <div class="col-12">
              ...
              <h2 class="page-header text-center">
                @if ($view_singteachers->centername = 'Uyo')
                  Unit 13 F-Line Ewet Housing Estate, Uyo
                  Akwa Ibom, Nigeria
                @else
                  Abuja Asokoro
                @endif
              ...
              <div class="card-body">
                <form class="form-horizontal" action="{{ url('admin/settingsupdate/'.$view_singteachers->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ $view_singteachers->fatheraddress }}" name="phone" id="inputName2" placeholder="phone">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <div class="offset-sm-2 col-sm-10">
                        <a class="btn btn-primary" href="../lecturersprint/{{ $view_singteachers->ref_no }}">Print</a>
